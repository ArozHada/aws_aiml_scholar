...
model_id = st.sidebar.selectbox("Select LLM Model", ["amazon.nova-premier-v1:0","amazon.titan-text-lite-v1", "anthropic.claude-3-haiku-20240307-v1:0", "anthropic.claude-3-5-sonnet-20240620-v1:0"])
kb_id = st.sidebar.text_input("Knowledge Base ID", "EFUXG1B1NG")
